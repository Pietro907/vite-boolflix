...
<template>
  ...
  <ul style="margin: 2rem 0 0 20rem;" v-for="film in this.state.films">
    ...
    <li><img class="preview_img" :src=" film.backdrop_path ? 'https://image.tmdb.org/t/p/w342/' + `${film.backdrop_path}` : 'https://upload.wikimedia.org/wikipedia/commons/f/f3/HTTP_404_animated.gif'" alt=""></li>
